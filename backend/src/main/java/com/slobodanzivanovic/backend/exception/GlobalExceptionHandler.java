...
public class GlobalExceptionHandler {
	...
	/**
	 * Handle all other unhandled exceptions. Acts as a catch-all for any exceptions not
	 ...
	 * Processes MethodArgumentNotValidException which occurs when @Valid validation fails
	 * on a method argument, typically request bodies.
	 *
	 ...
	 * does not match the expected type, often for path variables or request parameters.
	 * </p>
	 *
